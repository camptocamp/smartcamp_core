...
ADDONS_TO_EXTRACT = {
    ...
    ("edi", "camptocamp", "17.0-mig-base_ebill_payment_contract"): (
        "base_ebill_payment_contract",
    ),
    ("edi", "camptocamp", "17.0-mig-account_invoice_export"): (
        "account_invoice_export",
    ),
    ("l10n-switzerland", "camptocamp", "17.0-mig-ebill_postfinance"): (
        "ebill_postfinance",
    ),
}
